...
pub use aarch64::{
    ...
    get_host_cpu_phys_bits, get_kernel_start, get_ram_start, get_uefi_start, initramfs_load_addr,
    layout, layout::CMDLINE_MAX_SIZE, layout::IRQ_BASE, set_fdt_addr, set_kernel_start,
    set_ram_start, uefi, EntryPoint,
};
